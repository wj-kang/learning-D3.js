function initialiseGroup(g) {
  g.classed('country', true).on('mouseover', handleMouseover).on('mouseout', handleMouseout);

  g.append('circle').classed('popup-center', true).attr('r', 1);
...
function updateGroup(d, i) {
  ...
  g.select('.popup-center').attr('cy', d.popupOffset);
